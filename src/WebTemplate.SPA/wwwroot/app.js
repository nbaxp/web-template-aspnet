...
const template = html`
  <el-config-provider :size="appStore.size" :locale="locale" :button="{autoInsertSpace: true}">
    <router-view />
  </el-config-provider>
`;
...
export default {
  ...
  setup() {
    ...
    const locale = computed(() => {
      //return locales.get(appStore.locale.current);
      console.log(appStore.locale.current);
    });
    return {
      appStore,
      locale,
